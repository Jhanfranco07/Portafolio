    ...
    <section id="projects" className="relative overflow-hidden bg-slate-950 py-20 lg:py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          title="Casos realistas alineados a desarrollo web, gestión, datos e IA aplicada."
          description="Estos ejemplos muestran el tipo de soluciones que puedo construir. No son cifras infladas ni casos ajenos al perfil: son líneas de trabajo concretas y creíbles."
          tone="dark"
        />
    ...
    >
      ...
      <div className="p-6">
        ...
        <button
          type="button"
          onClick={onOpen}
          className="mt-6 inline-flex items-center gap-2 rounded-lg border border-slate-300 px-4 py-2.5 text-sm font-bold text-slate-800 transition duration-300 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700"
        >
          Ver más
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white px-5 py-4 sm:px-6">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <h3 id="project-modal-title" className="truncate text-lg font-black text-slate-950 sm:text-2xl">
                {project.title}
              </h3>
            </div>
          </div>
          <button
            type="button"
            onClick={onClose}
            className="ml-3 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg border border-slate-200 text-slate-600 transition hover:bg-slate-100"
          ...
          <div>
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-2">
              {project.highlights.map((highlight) => (
                <div key={highlight} className="rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-700">
                  {highlight}
                </div>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="mt-3 flex flex-wrap gap-3">
              {project.technologies.map((tech) => (
                <div key={tech} className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 shadow-sm">
                  <TechLogo name={tech} />
